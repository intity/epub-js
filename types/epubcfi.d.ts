...
export default class EpubCFI {
    ...
    private findNode(steps: EpubCFIStep[], doc?: Document, ignoreClass?: string): Node;
    private fixMiss(steps: EpubCFIStep[], offset: number, doc?: Document, ignoreClass?: string): any;
    ...
    private joinSteps(steps: EpubCFIStep[]): EpubCFIStep[];
    private normalizedMap(children: Node[], nodeType: number, ignoreClass?: string): object;
    ...
    private stepsToQuerySelector(steps: EpubCFIStep[]): string;
    private stepsToXpath(steps: EpubCFIStep[]): string;
    private textNodes(container: Node, ignoreClass?: string): Node[];
    private walkToNode(steps: EpubCFIStep[], doc?: Document, ignoreClass?: string): Node;
}